...
const MatsuProjectPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>New t-shirt launch | Matsu Be Stylise</title>
        <meta
          name="description"
          content="Project page for Matsu Be Stylise featuring the t-shirt launch campaign and outdoor lifestyle visuals."
        />
      </Helmet>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed text-sm md:text-base">
                      This project documents a new t-shirt launch by taking the product out of the studio and into the
                      elements. Shot entirely in outdoor settings, the photography emphasizes real-world movement and
                      the raw textures of nature. By utilizing natural light and candid compositions, the visuals
                      highlight the brand's versatility and its connection to an active, authentic lifestyle.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="relative flex items-center justify-center px-8 md:px-10">
                    ...
                    <div className="group relative w-fit max-w-full">
                      <motion.img
                        ...
                        alt={`Matsu project image ${activeImageIndex + 1}`}
...
export default MatsuProjectPage;
